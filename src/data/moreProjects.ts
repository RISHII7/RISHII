...
export const moreProjects: FeaturedProject[] = [
  ...
  },
  {
    ...
    slug: "fizzie",
    title: "FIZZIE",
    category: "Starter Framework",
    description:
      "A minimal, type-safe Prismic + Next.js starter — slice architecture, live preview, and zero boilerplate for content-driven sites",
    tags: ["Next.js", "TypeScript", "Prismic", "Slice Machine", "Tailwind"],
    metrics: [
      { value: "98.6%", label: "TypeScript, fully typed content" },
      { value: "SLICES", label: "modular drag-and-drop content" },
      { value: "LIVE", label: "preview-enabled, deployed" },
    ],
    image: "/images/projects/fizzie.png",
    href: "https://fizzie.vercel.app",
    github: "https://github.com/RISHII7/fizzie",
    detail: {
      role: "SOLO BUILD — DX TOOLING",
      timeline: "SHIPPED · LIVE",
      scope: ["CMS integration", "Preview system", "Slice architecture", "Type generation"],
      summary:
        "Every content site starts with the same week of boilerplate. Fizzie deletes that week: a pre-wired Prismic + Next.js foundation with dynamic routing, draft previews and typed slices, ready for real work on day one.",
      pullquote: "The best starter is the one you never notice again after day one.",
      body: [
        "Fizzie wires the full Prismic stack — client, React renderers and Next.js integration — into an App Router project with dynamic /[uid] page routing, so editors create pages from the CMS dashboard without touching code.",
        "The preview system covers both localhost and production through dedicated API routes, with a slice simulator for developing content components in isolation. Slice Machine manages the custom-type schemas, and the codebase holds 98.6% strict TypeScript so content models stay typed end to end.",
      ],
    },
  },
];
